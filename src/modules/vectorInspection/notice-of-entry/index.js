...
const NoticeOfEntry = ({
  ...
  useEffect(() => {
    document.title = 'NEA | Notice of Entry';
  ...
  useEffect(() => {
    filterAction({ sortValue, searchText: debounceSearchText, searchType, datePickerValue });
  }, [debounceSearchText, searchType, datePickerValue, filterAction, sortValue]);
    ...
    <>
      ...
      <div className="main-content">
        ...
        <div className="contentWrapper">
          ...
          <GoBackButton onClick={goBack} title={`Back to ${noticeType?.descText || ''}: Notice to Entry`} />
