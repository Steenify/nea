...
import { queryLdRemarksByMonthAndYearService, collateApproveLDService } from 'services/site-paper-gravitrap-audit';
    ...
    if (rowInfo && rowInfo.row) {
      return {
        onClick: () => {
          ...
          getTemplateAction({ month, year, workspace: false });
        },
