...
import { pendingResubmissionListingService } from 'services/site-paper-gravitrap-audit';
...
const Table = (props) => {
  ...
  const getListingAction = useCallback(() => {
    ...
    const onSuccess = (data) => {
      ...
      filterListingAction(mappedList);
    };
    const onError = () => {
      setIsLoading(false);
    };
    actionTryCatchCreator(pendingResubmissionListingService(), onPending, onSuccess, onError);
  }, [filterListingAction]);
